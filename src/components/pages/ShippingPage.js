        ...
        <div className="prose prose-lg dark:prose-invert max-w-none space-y-8 text-muted-foreground">
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 mt-2">
              <li><strong>الشحن داخل المدن الرئيسية:</strong> جدة، مكة المكرمة.</li>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 mt-2">
              <li><strong>داخل المدن الرئيسية:</strong> من 5 إلى 7 أيام عمل من تاريخ تأكيد الطلب.</li>
              <li><strong>المناطق الأخرى:</strong> من 7 إلى 12 أيام عمل من تاريخ تأكيد الطلب.</li>
              <li><strong>المناطق النائية:</strong> قد يستغرق التوصيل من 12 إلى 15 أيام عمل.</li>
            </ul>
            <p className="mt-4">
