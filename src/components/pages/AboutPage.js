      ...
      questions: [
        {
          ...
          answer: `
          المنتجات العضوية هي منتجات زراعية تم إنتاجها دون استخدام مبيدات حشرية صناعية، أو أسمدة كيماوية، أو كائنات معدلة وراثياً. هي منتجات طبيعية 100% تحافظ على صحتك وصحة البيئة.
          `
        },
        {
          question: "هل جميع منتجات سِدر عضوية, وحاصلة على شهادات",
          answer: `
          نعم, جميع منتجات سدر عضوية، ولكن ليس جميعها حاصلة على شهادة عضوية. نحاول توفير أكبر قدر ممكن من المنتجات الحاصلة على شهادات عضوية.
          `
        }
      ]
    },
      ...
      questions: [
        {
          ...
          answer: "تستغرق عملية التوصيل داخل المدن الرئيسية من 5 إلى 7 أيام عمل للشحن المجاني، وفي باقي المناطق من 7 إلى 12 يوم عمل. كما نوفر خدمة التوصيل السريع خلال 24 ساعة للمناطق الرئيسية."
        },
        {
          question: "كيف يمكنني تتبع طلبي؟",
          answer: "بعد إتمام الطلب، ستصلك رسالة نصية وبريد إلكتروني يحتويان على رابط تتبع الشحنة. يمكنك أيضاً متابعة حالة الطلب من خلال حسابك في الموقع، عبر صفحة تتبع الطلبات."
        }
      ]
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          answer: "نعم، نوفر خدمة الدفع عند الاستلام بالإضافة إلى خيارات الدفع الإلكتروني المتعددة مثل البطاقات الائتمانية، ومدى، وتابي، وتمارا. كما نسعى إلى إضافة طرق دفع أخرى."
        }
      ]
    }
  ];
