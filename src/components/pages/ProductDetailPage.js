        ...
        <div className="container mx-auto px-4 py-12">
          <div className="grid lg:grid-cols-2 gap-12 mb-16">
            ...
            <div>
              ...
              <h1 className="mb-2">زيت زيتون عضوي فاخر</h1>
              ...
              <div className="flex items-baseline gap-3 mb-6">
                <span className="text-4xl text-primary">$24.99</span>
              ...
              <div className="mb-6">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <span className="text-sm text-muted-foreground">
                    الإجمالي: ${(24.99 * quantity).toFixed(2)}
                  </span>
                </div>
              </div>
          ...
          <Tabs defaultValue="description" className="mb-16">
            <TabsList className="w-full justify-start border-b rounded-none h-auto p-0 bg-transparent">
              ...
              <TabsTrigger value="ingredients" className="rounded-none">
                المكونات
              </TabsTrigger>
              <TabsTrigger value="nutrition" className="rounded-none">
                المعلومات الغذائية
              </TabsTrigger>
            ...
            <TabsContent value="ingredients" className="mt-6">
              <p className="mb-4">100% زيت زيتون بكر ممتاز عضوي</p>
