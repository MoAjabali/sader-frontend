        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
          {categories.map((category, index) => (
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className={`bg-${category.color}/10 rounded-2xl overflow-hidden transition-all hover:shadow-lg grid sm:grid-cols-2 grid-cols-1 items-center justify-center`}
            >
              <div className={`text-4xl text-right mb-4 text-${category.color} p-8`}>
